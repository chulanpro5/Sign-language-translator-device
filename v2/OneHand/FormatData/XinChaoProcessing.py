                ...
                for finger in range(0 , 5 , 1):
                    for curJoint in joint:
                        for id in range(len(curData['pointables'][finger][curJoint])):
                            ...
                            if id == 0: Right.append(curData['pointables'][finger][curJoint][id] - palm[id] + 138)
                            if id == 2: Right.append(curData['pointables'][finger][curJoint][id] - palm[id] + 46)
...
with open('MoiNguoi(edit).json', 'w') as outfile:
